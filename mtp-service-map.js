...
module.exports = {
  tiktok: {
    ...
    views:     { standard: 9742, premium: 9744, vip: 9744 }, // CORRIGE — l'ancien ID 9743 (Vues Monetisables) exige un minimum de 100 000 vues par commande chez MoreThanPanel, incompatible avec les petites commandes. Remplace par : Real 30j Refill Drip-Feed $0.14 (min normal) / Views SEO Retention $0.51 (min normal). Pas de 3e ID a min raisonnable trouve pour l'instant, premium et vip utilisent le meme.
