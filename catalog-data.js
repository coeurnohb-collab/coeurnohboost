...
const SERVICE_CATALOG = {
  ...
  facebook:  [
    ...
    { type:"shares",     label:"Partages",       price:{standard:2.0,  premium:3.2,  vip:5.0},  min:50,  max:10000 } // ⚠️ À VÉRIFIER (prix d'exemple)
  ],
  twitter:   [
    ...
    { type:"shares",     label:"Retweets", price:{standard:2.2,  premium:3.52, vip:5.5},   min:50,  max:20000 }, // ⚠️ À VÉRIFIER (prix d'exemple)
  ...
  telegram:  [
    ...
    { type:"views",      label:"Vues Post",   price:{standard:0.8,  premium:1.28, vip:2.0}, min:500, max:200000 } // ⚠️ À VÉRIFIER (prix d'exemple)
  ],
  whatsapp:  [
  ...
  linkedin:  [
    { type:"followers", label:"Abonnés",     price:{standard:5.0,   premium:8.0,   vip:12.5},  min:50, max:20000 }, // ⚠️ À VÉRIFIER (prix d'exemple)
  ...
  spotify:   [
    ...
    { type:"followers",  label:"Abonnés", price:{standard:3.5,  premium:5.6,  vip:8.75}, min:100, max:20000 } // ⚠️ À VÉRIFIER (prix d'exemple)
  ],
  discord:   [
  ...
  reddit:    [
    ...
    { type:"likes",      label:"Upvotes", price:{standard:2.5,  premium:4.0,  vip:6.25}, min:20, max:10000 } // ⚠️ À VÉRIFIER (prix d'exemple)
  ],
  soundcloud:[
