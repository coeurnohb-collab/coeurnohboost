...
const SERVICE_CATALOG = {
  tiktok:    [
    ...
    { type:"comments",   label:"Commentaires",  price:{standard:7.20,  premium:9.60,  vip:12.00}, min:5,  max:500000 }, // MAJ ID 9848 (MoreThanPanel) — achat $4.80/1000 (Custom, Speed 1-5K/Day)
  ...
  instagram: [
    ...
    { type:"comments",   label:"Commentaires",  price:{standard:10.98, premium:14.64, vip:18.30}, min:20, max:10000 } // MAJ ID 6226 (MoreThanPanel) — achat $7.32/1000 (Auto Random Comments)
  ],
  youtube:   [
    ...
    { type:"likes",      label:"Likes",    price:{standard:2.09,  premium:2.78,  vip:3.48},  min:10,   max:100000 }, // MAJ ID 9539 (MoreThanPanel) — achat $1.39/1000 (Likes vidéo confirmées, 30 Day Refill Speed 10-20K/Day) — remplace l'ancien prix basé par erreur sur "Comment Likes"
    { type:"watchtime",  label:"Watch Time (heures de visionnage)", price:{standard:39.60, premium:52.80, vip:66.00}, min:100, max:4000 } // MAJ ID 8866 (MoreThanPanel) — achat $26.40/1000 (WatchTime Views 30 Day Refill, 60-70 Min+ Video). Vérifie que min/max (100-4000) correspond bien à ce que tu veux vendre.
  ],
  facebook:  [
    ...
    { type:"likes",      label:"Likes Post",     price:{standard:0.77, premium:1.02, vip:1.28}, min:50,  max:500000 }, // MAJ ID 9787 (MoreThanPanel) — achat $0.51/1000 (Post Likes, 30 Day Refill, Old Accounts)
  ...
  snapchat:  [
    ...
    { type:"views",      label:"Vues Story",price:{standard:35.09, premium:46.78, vip:58.48},   min:100, max:50000 } // MAJ ID 8393 (MoreThanPanel) — achat $23.39/1000 (Story Views, First 5 Stories)
  ],
  linkedin:  [
...
const MONETIZATION_SERVICES = [
  ...
  },
  {
    ...
    description: "Heures de visionnage nécessaires à la monétisation, vidéos 60min+",
    price: { standard: 39.60, premium: 52.80, vip: 66.00 } // MAJ ID 8866 (MoreThanPanel) — achat $26.40/1000 (même base que SERVICE_CATALOG.youtube.watchtime)
  },
  {
