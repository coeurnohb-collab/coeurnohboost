...
module.exports = {
  tiktok: {
    ...
    comments:  { standard: null, premium: null, vip: null }, // aucun ID confirme (prix catalogue encore "a verifier")
  ...
  instagram: {
    ...
    comments:  { standard: null, premium: null, vip: null }  // aucun ID confirme (offres vues = "Split Delivery" a prix fixe, pas 3 niveaux de qualite)
  },
  youtube: {
    ...
    likes:     { standard: null, premium: null, vip: null }, // NON CONFIRME — l'ID 912 vu dans catalog-data.js concerne "Comment Likes", pas les Likes video. A verifier avant d'automatiser.
  ...
  reddit: {
    followers: { standard: 8039, premium: 8039, vip: 8039 }, // meme ID x3 — achat $2.40/1000
    likes:     { standard: 7339, premium: 7339, vip: 7339 }  // meme ID x3 — achat $13.05/1000 (Upvotes)
  },
  soundcloud: {
