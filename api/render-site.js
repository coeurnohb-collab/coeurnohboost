...
<div class="wrap">
  ...
  <div class="section" id="site-sec-blog">
    <h2>Actualités</h2>
    ${blogPosts.map((post) => `
    <div class="card" style="margin-left:0;margin-right:0;padding:0;overflow:hidden">
      ${post.imageUrl ? `<img src="${escapeAttr(post.imageUrl)}" alt="" style="width:100%;max-height:220px;object-fit:cover;display:block">` : ''}
      <div style="padding:16px">
        ${post.category ? `<span class="pill" style="display:inline-block;margin-bottom:6px;font-size:.72rem">${escapeHtml(post.category)}</span>` : ''}
