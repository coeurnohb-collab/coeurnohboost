...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .cover{width:100%;height:180px;object-fit:cover;background:linear-gradient(135deg,var(--accent),#000)}
  .header{padding:0 18px;margin-top:-40px}
  .avatar{width:84px;height:84px;border-radius:50%;object-fit:cover;border:4px solid #f3ede1;background:var(--accent);display:flex;align-items:center;justify-content:center;color:#fff;font-size:2rem;font-weight:800}
  h1{font-size:1.4rem;margin:10px 0 2px}
  .tagline{color:#4a4640;margin:0 0 6px}
  .meta{font-size:.85rem;color:#6b675f;margin:2px 0}
  .pills{display:flex;gap:8px;flex-wrap:wrap;padding:14px 18px 0}
  .pill{border:1px solid #ddd6c8;background:#fff;color:#1c1a17;border-radius:999px;padding:6px 12px;font-size:.8rem;font-weight:700;text-decoration:none}
  .card{background:#fff;border:1px solid #ece5d6;border-radius:14px;padding:16px;margin:14px 18px}
  .section{margin:20px 18px}
  .section h2{color:var(--accent);font-size:1.05rem;margin-bottom:10px}
  .gallery{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}
  .gallery img{width:100%;aspect-ratio:1;object-fit:cover;border-radius:8px}
  .btn{display:inline-flex;align-items:center;gap:8px;background:var(--accent);color:#fff;text-decoration:none;padding:11px 18px;border-radius:999px;font-weight:700;font-size:.9rem}
  .btn-outline{background:#fff;color:#1c1a17;border:1px solid #ddd6c8}
  .actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:10px}
  details{border:1px solid #ece5d6;border-radius:10px;padding:10px 12px;margin-bottom:8px;background:#fff}
  summary{font-weight:700;cursor:pointer}
  .quote{font-style:italic;margin:0 0 6px}
  .fixedbar{position:fixed;left:0;right:0;bottom:0;padding:10px 14px;background:#fff;border-top:1px solid #ece5d6}
...
<div class="wrap">
  ...
  <div class="section" id="site-sec-contact">
    <div class="actions">
      ${waLink ? `<a class="btn" href="${escapeAttr(waLink)}" target="_blank" rel="noopener">WhatsApp</a>` : ''}
...
${waLink ? `<div class="fixedbar"><a class="btn" href="${escapeAttr(waLink)}" target="_blank" rel="noopener">Contacter sur WhatsApp</a></div>` : ''}
</body></html>`;
